...
from app.helpers import (
    datetime_to_time, encode_recorder_key, increase_last_digit,
    time_to_datetime, parse_filtering_dates
)
...
def test_datetime_timestamp_conversions():
    dnow = datetime.now()
    t = datetime_to_time(dnow)
